    ...
    <aside :class="{
        ...
        <div class="flex items-center justify-between h-16 bg-indigo-700">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center" :class="{ 'justify-center': sidebarMinimized }">
                ...
                <span class="text-white text-xl font-bold" x-show="!sidebarMinimized">Admin</span>
            </a>
        ...
        <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('admin.dashboard') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-150 hover:bg-gray-100 text-gray-700" :class="{ 'justify-center': sidebarMinimized }">
                <svg class="h-6 w-6 {{ request()->routeIs('admin.dashboard') ? 'text-indigo-700' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="bg-blue-500 text-white rounded-lg shadow-md p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-blue-100 text-sm mt-2">+null hari ini</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-green-500 text-white rounded-lg shadow-md p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-green-100 text-sm mt-2">null aktif</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-purple-500 text-white rounded-lg shadow-md p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-3xl font-bold mt-2">null</p>
                                        <p class="text-purple-100 text-sm mt-2">null% dari kemarin</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-red-500 text-white rounded-lg shadow-md p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-3xl font-bold mt-2">null</p>
                                        <p class="text-red-100 text-sm mt-2">null belum selesai</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-white rounded-lg shadow-md p-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                        <div class="flex-shrink-0">
                                            <span class="inline-block h-10 w-10 rounded-full bg-gray-100 text-gray-500">
                                        ...
                                        <div class="ml-4">
                                            <p class="text-sm font-medium text-gray-900">desk</p>
                                            <p class="text-sm text-gray-500">crt_at</p>
                                        </div>
                                    </div>
                                    {{-- @empty --}}
