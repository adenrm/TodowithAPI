...
<div x-data="{ 
    ...
    <aside :class="{
        ...
        <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('superadmin.todo') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-150 hover:bg-gray-100 bg-indigo-50 text-indigo-700" :class="{ 'justify-center': sidebarMinimized }">
                        ...
                        <div class="space-y-8">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="tugas" id="tugas" value="{{$data['tugas']}}">
                                    </td>
                                </tr>
                                 <tr>
                                    <td>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name="tugas_dari" value="{{$data['tugas_dari']}}">
                                         <?php
                                            $penugasnya = App\Models\User::find($data['tugas_dari']);
                                        ?>
                                        {{ $penugasnya->name }}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name="tugas_untuk" value="{{$data['tugas_untuk']}}">
                                         <?php
                                            $pelaksana = App\Models\User::find($data['tugas_untuk']);
                                        ?>
                                        {{ $pelaksana->name }}
                                    </td>
                                </tr>
                                <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name="waktu_selesai" value="{{$data['waktu_selesai']}}">
                                        {{ $data['waktu_selesai'] }}
                                    </td>
                                </tr>
                            </table>
