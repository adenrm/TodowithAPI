...
class DashboardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $formatMulai = $datetimeMulai->format('Y-m-d H:i:s'); // "2025-06-01 14:30:00"
        $formatSelesai = $datetimeSelesai->format('Y-m-d H:i:s'); // "2025-06-01 14:30:00"
        $parameter = [
            'tugas' => $tugas,
        ...
        if ($contentArray['status'] != true) {
            ...
            return redirect()->to('superadmin/todo')->withErrors($error);
        } else {
            return redirect()->to('superadmin/todo')->with('success', 'Sukses!');
        }
    }
     ...
     public function update(Request $request, string $id)
    {
        ...
        if ($contentArray['status'] != true) {
            ...
            return redirect()->to('superadmin/todo')->with('success', 'Sukses Update Data!');
        }
    }
     ...
     public function destroy(string $id)
    {
        ...
        return redirect()->to('superadmin/todo')->with('success', 'Sukses Hapus Data!');
    }
}
